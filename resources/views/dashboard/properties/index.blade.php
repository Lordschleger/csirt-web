        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Media</th> <!--Mengubah 'Image' menjadi 'Media' untuk mencakup gambar dan video -->
              ...
              <tr>
                ...
                <td>
                  @if ($property->file_type === 'picture')
                    <!-- Tampilkan gambar jika file_type adalah 'picture' -->
                    <img src="{{ asset('storage/' . $property->image) }}" alt="{{ $property->name }}" class="img-fluid col-sm-5">
                  @elseif ($property->file_type === 'video')
                    <!-- Tampilkan video jika file_type adalah 'video' -->
                    <video class="img-fluid col-sm-5" controls>
                      <source src="{{ asset('storage/' . $property->image) }}" type="video/mp4">
